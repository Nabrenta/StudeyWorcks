...
{
	{
		...
		Library lib(/*mbooks*/ true);//параметр фіктивний, жодного змісту немає. Компілятор з незрозумілих причин відмовляється сприймати явно прописаний конструктор за замовченням
		cout << endl;
		...
		cin >> librar;
		cout << "CREATING:" << endl;
		Library lib1(study, fiction, electric, librar/* mbooks1*/);//створення бібліотеки конструктором ініціалізації
		cout << endl;
