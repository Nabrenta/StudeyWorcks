...
const std::string Book::getSubj()
{
	return subject;
}

//Визначити, чи книга доступна
const bool Book::getAvail()
{
	return avail;
}

//повернути обмеження на видачу
const limit Book::getLimit()
{
	return limitAsses;
}

//повернути дату видачі
const date Book::getDat()
{
	return putDate;
}

//повернути стан
const int Book::getStay()
{
	return stay;
}

//повернути ідентифікаційний номер
const std::string Book::getCode()
{
	return code;
}

//повернути вартість
const int Book::getCost()
{
	return cost;
}

//повернути тип
const types Book::getType()
{
	return type;
}
